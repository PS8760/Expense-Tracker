    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-[#1E2938] to-gray-900 backdrop-blur-md">
      <div className="bg-[#1E2938]/90 p-8 rounded-2xl shadow-2xl w-full max-w-sm border border-gray-700">
        <h2 className="text-3xl font-bold text-white mb-6 text-center">
          Login to <span className="text-green-500">BudgetBuddy</span>
        </h2>
        {error && (
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2 bg-green-600  border  hover:bg-green-700 rounded-lg text-white font-semibold transition"
          >
            Continue
          </button>
        </form>
        ...
        <button className="w-full flex items-center justify-center gap-2 py-2  rounded-lg text-white hover:bg-gray-700 transition">
          <FcGoogle size={20} />
